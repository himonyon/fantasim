...
bool Main::Init(void* hWnd) {
	...
	//ゲーム------------------------------------------------
	Attribute::InitAttribute(); //属性作成
	AttackSkill::InitAttackSkill(); //スキル作成
	HealSkill::InitHealSkill(); //スキル作成
	BuffSkill::InitBuffSkill(); //スキル作成
...
void Main::Destroy() {
	...
	Skill::DestroySkill(); //スキル破棄
	Attribute::DestroyAttribute(); //属性破棄
